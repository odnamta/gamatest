...
export default function SkillDetailError({ error, reset }: ErrorProps) {
  const router = useRouter()

  useEffect(() => {
    logger.error('skills.detail.error', error)
  }, [error])
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16 text-center">
      ...
      <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">
        Terjadi kesalahan saat memuat skill ini. Silakan coba lagi.
      </p>
