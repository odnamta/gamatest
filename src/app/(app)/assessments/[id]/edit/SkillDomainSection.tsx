...
/**
 * Skill Domain Linking Section (V19) — Edit Page variant
 ...
 * (only when skillsEnabled is true).
 */
...
interface SkillDomainSectionProps {
  ...
  /** Whether the current user can modify links */
  canEdit: boolean
}

export default function SkillDomainSection({ deckTemplateId, canEdit }: SkillDomainSectionProps) {
