...
- [ ] 1.1 Create pure function for generating day array with configurable count
...
- [ ]* 1.2 Write property test for day array generation
  - **Property 2: Heatmap Day Ordering**
  - **Validates: Requirements 1.4**

- [ ] 1.3 Create responsive day count hook
...
- [ ]* 1.4 Write property test for responsive day count
  - **Property 1: Heatmap Day Count by Viewport**
  - **Validates: Requirements 1.1, 1.2**

- [ ] 1.5 Refactor StudyHeatmap component for responsive grid
...
- [ ] 2.1 Update LibrarySection to conditionally render Courses
...
- [ ] 4.1 Create SourceBar component
...
- [ ] 4.2 Update BulkImportPage with conditional source display
...
- [ ] 5.1 Create TextSelectionToolbar component
...
- [ ] 5.2 Implement text transfer logic with field targeting
...
- [ ]* 5.3 Write property test for text selection transfer
  - **Property 3: Text Selection Transfer**
  - **Validates: Requirements 5.2**

- [ ]* 5.4 Write property test for focus sequencing
  - **Property 4: Focus Sequencing After Paste**
  - **Validates: Requirements 5.3**

- [ ] 5.5 Integrate TextSelectionToolbar into BulkImportPage
...
- [ ] 6.5 Replace BulkMCQForm with shared CreateMCQForm
...
- [ ] 6.6 Final Checkpoint - Ensure all tests pass
  - Ensure all tests pass, ask the user if questions arise.
